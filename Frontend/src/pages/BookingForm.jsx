      ...
      <div className="container mx-auto px-6 lg:px-8 py-12">
        <div className="flex flex-col lg:flex-row items-center mt-20">
                  ...
                  <div>
                    ...
                    <div className="mb-4">
                      ...
                      >
                        ...
                        <option value="GeneralCommercialCleaning">
                          General Commercial Cleaning
                        </option>
                        <option value="HighPresureWaterBlasting">
                          High Presure Water Blasting
                        </option>
                        <option value="CarpetSteamCleaningandMaintains">
                          Carpet Steam Cleaning and Maintains
                        </option>
                        <option value="BuildersCleaning">
                          Builders Cleaning
                        </option>
                        <option value="BondCleaning">Bond Cleaning</option>
                        <option value="HouseResidentalCleaning">
                          House / Residental Cleaning
                        </option>
                        <option value="OfficeCleaning">Office Cleaning</option>
                        <option value="WarehouseCleaning">
                          Warehouse Cleaning
                        </option>
                        <option value="HospitalCleaning">
                          Hospital Cleaning
                        </option>
                        <option value="SchoolCleaning">School Cleaning</option>
                        <option value="NewlyConstructedCleaning">
                          Newly Constructed Cleaning
                        </option>
                        <option value="GovernmentProjecCleaning">
                          Government Projec Cleaning
                        </option>
                        <option value="HotelCleaning">Hotel Cleaning</option>
                        <option value="RestaurentCleaning">
                          Restaurent Cleaning
                        </option>
                        <option value="OfficeBoyandMaidService">
                          Office Boy and Maid Service
                        </option>
                      </select>
                    </div>
                  ...
                  <div>
                    ...
                    <div className="mb-4">
                      ...
                      <select
                        ...
                        className="appearance-none block w-full bg-blue-50 text-gray-700 border border-secondary rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white"
                        onChange={handleChange}
                        defaultValue="" // Sets the default to the "Select one" option
                        required
                      >
                        <option value="" disabled>
                          Select one
              ...
              {/* <form onSubmit={handleSubmit}>
                <div className="mx-auto flex flex-wrap gap-10 justify-center">
                  <div>
                    ...
                    <div className="mb-4">
                      <label htmlFor="serviceType" className="block mb-2">
                        <span className="text-red-500">*</span> Type of Visit
                      </label>
                      <select
                        id="serviceType"
                        className="appearance-none block w-full bg-blue-50 text-gray-700 border border-secondary rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white"
                  ...
                  <div>
                    ...
                    <div className="mb-4">
                      <label htmlFor="paymentMethod" className="block mb-2">
                        <span className="text-red-500">*</span> Preferred
                        Payment Method
                      </label>
                      <select
                        id="paymentMethod"
                    ...
                    <div className="mb-4">
                      <label htmlFor="allergies" className="block mb-2">
                        <span className="text-red-500"></span> Any Allergies or
                        Sensitivities
                      </label>
                      <textarea
                        onChange={handleChange}
                    ...
                    <div className="mb-4">
                      <label htmlFor="additional" className="block mb-2">
                        <span className="text-red-500"></span> Special
          ...
          <div className="md:hidden p-4 bg-secondary text-white w-11/12 mx-auto rounded-md shadow-md">
            ...
            <p>
              Once you submit your appointment request, it will be reviewed by
              our service team. Upon approval, you will receive a confirmation
              with the scheduled date and time. Our service provider will arrive
              at the specified time to fulfill your cleaning needs. Thank you
